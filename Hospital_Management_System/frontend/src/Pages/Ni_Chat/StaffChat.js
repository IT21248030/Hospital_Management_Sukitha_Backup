...
class StaffChat extends Component {
    ...
    navigateAdminUsers = (e) => {
        ...
        //write axios call to get all admin users
        const adminUsersList = [{
            "name": "rathnapala jayaweera",
            "id": "AD0002"
        },
        {
            "name": "kumari hewage",
                            ...
                            <Row>
                                            ...
                                            <Row>
                                                ...
                                                <Col >
                                                    <Button style={{ "backgroundColor": "#649da9", "float": "right", "height": "30px", "marginTop": "2px", "fontSize": "larger" }} className="btn " variant="addDel" type="submit" onClick={this.navigateAdminUsers}>
                                                        <GrUserAdmin style={{ "alignItems": "center", "backgroundColor": "#649da9", "height": "34spx", "marginTop": "-20px", "fontSize": "larger" }} />
                                                    </Button>
                                                </Col>
                                                <Col >
                                ...
                                <div className={AccountCSS.containertwo}>
                                        ...
                                        <ScrollableFeed>
                                            {
                                                ...
                                                this.state.allMessages.map(muBobject => (
                                                    ...
                                                    </span>}</h5> <div style={{ "fontSize": "small", "marginBottom": "12px", "marginTop": "-5px", "marginLeft": "5px", "marginRight": "10px" }}>{muBobject.sennder == this.state.sennder.sennderID && muBobject.seenStatus == 'true' ? <BsCheckAll /> : muBobject.sennder == this.state.sennder.sennderID && <BsCheck />}</div><h5
                                    ...
                                    {this.state.reciver.reciverID && <>
                                        ...
                                        <div style={{ "minHeight": "10vh", "marginLeft": "-12px", "width": "1150px", "backgroundColor": "rgb(255 255 255)" }} className="container" >
                                            <Form >
